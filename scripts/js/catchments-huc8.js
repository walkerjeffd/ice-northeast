...
const saveFile = (huc) => {
  const filename = `${dataDirectory}/huc8/${huc.id}.json`

  if (!fs.existsSync(`${dataDirectory}/huc8`)) {
    console.log(`creating directory: ${dataDirectory}/huc8`)
    fs.mkdirSync(`${dataDirectory}/huc8`)
  }
